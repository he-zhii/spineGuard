...
const HEALTH_CARDS = [
  {
    id: 1,
    title: "SYSTEM_ALERT: ORTHOSTATIC_RISK", // 起立晕厥风险
  ...
  {
    id: 2,
    title: "SYSTEM_ALERT: CERVICAL_STRAIN", // 颈椎劳损
  ...
  {
    id: 3,
    title: "SYSTEM_ALERT: OCULAR_FATIGUE", // 视觉疲劳
...
export default function SpineGuardCLI() {
  ...
  // --- 初始化与持久化 ---
  useEffect(() => {
    const savedTasks = localStorage.getItem('spineguard_tasks');
    if (savedTasks) {
          ...
          <div className="p-6 overflow-y-auto flex-1">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  onClick={() => { setIsBreakMode(false); resetTimer(); }}
  ...
  return (
    <div className={`min-h-screen ${THEME.bg} ${THEME.text} font-mono selection:bg-green-500 selection:text-black flex flex-col`}>
      ...
      <nav className={`grid grid-cols-2 border-b ${THEME.border}`}>
        ...
        <button
          onClick={() => {
            if (activeTask) { setCurrentView('dashboard'); if (soundEnabled) playSound(); }
            else alert('ERROR: NO_TASK_LOADED');
          }}
      ...
      <main className="flex-1 p-4 sm:p-6 max-w-4xl mx-auto w-full">
            ...
            <div className="mb-8">
              ...
              <form onSubmit={handleAddTask} className="flex relative group items-stretch">
                <button
                  ...
                  title={`Current Tag: ${TAGS[newTaskTag].label}`}
                >
                ...
                <button type="submit" className="border border-green-800 border-l-0 px-4 sm:px-6 hover:bg-green-900/30 text-xs font-bold transition-colors">
                  ENTER
                </button>
              </form>
              ...
              <div className="divide-y divide-green-900/30">
                ...
                {tasks.map((task, idx) => {
                  ...
                  return (
                    <div
                      key={task.id}
                      className="grid grid-cols-12 gap-2 p-3 items-center hover:bg-green-900/10 transition-colors group relative"
                        ...
                        {!isConfirming && (
                          task.status === 'active' ? (
                            <button
                              ...
                              className="text-green-500 hover:text-white p-1"
                            >
            ...
            {tasks.some(t => t.status === 'done') && (
              <div className="mt-8">
                <div className="flex justify-between items-end mb-2 border-b border-green-900/30 pb-1">
                  ...
                  <button onClick={clearHistory} className="text-[10px] text-green-800 hover:text-red-500 flex items-center gap-1">
        ...
        {/* VIEW: DASHBOARD */}
        {currentView === 'dashboard' && activeTask && (
          <div className="flex flex-col items-center justify-center min-h-[50vh] animate-in zoom-in-95 duration-300">
            <div className="w-full max-w-xl border-2 border-green-800 bg-black relative shadow-[0_0_30px_rgba(22,163,74,0.1)]">
              ...
              <div className="p-8 sm:p-12 text-center">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold break-words mb-10 text-white glow-text">
                  {activeTask.title}
                </h1>
                ...
                <div className="flex justify-center gap-4">
                  {!isRunning ? (
                    <button
                      onClick={() => { setIsRunning(true); if (soundEnabled) playSound('start'); }}
